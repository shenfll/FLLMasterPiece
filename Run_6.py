...
async def main():
    ...
    await turn(150,45,right,relative=True)
    await runloop.sleep_ms(200)
    await straight(250,1050,smart=True)
    await runloop.sleep_ms(200)
    await straight(-300,300)
    await turn(200,110,left,relative=True)
    await straight(-500,1200)
    await straight(500,260)
    await turn(150,5,right,relative=True)
    await turn(150,30,left,relative=True)
    await runloop.sleep_ms(100)
    await straight(1500,1300)
