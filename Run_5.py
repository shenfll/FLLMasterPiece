...
async def main():
    #await attachment(500,360,right)
    #await attachment(500,360,left)
    #await straight(300,500)
    motion_sensor.reset_yaw(0)
    await straight(500,1100,smart=True)
    await turn(200,17,left,relative=True)
    await straight(500,1150,smart=True)
    await straight(-400,300)
    await turn(200,32,right,relative=True)
    await straight(200,460,smart=True)
    await turn(200,10,left,relative=True)
    await turn(200,40,right,relative=True)
    await runloop.sleep_ms(150)
    await straight(1500,1100,smart=True)
    await runloop.sleep_ms(150)
    await turn(150,10,left,relative=True)
    await runloop.sleep_ms(150)
    await turn(150,40,right,relative=True)
    await straight(1500,1200,smart=True)
runloop.run(main())
